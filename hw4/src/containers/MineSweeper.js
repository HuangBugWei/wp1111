...
const MineSweeper = () => {
    ...
    return (
        <div className='mineSweeper'>
            ...
            {/* {startGame ? <Board backToHome={backToHomeOnClick} boardSize={boardSize} mineNum={mineNum}/> : <HomePage startGameOnClick={startGameOnClick}/>} */}

            {/* Advanced TODO: pass all parameters into `Board` and `HomePage`*/}
            {startGame ? <Board mineNum={mineNum} boardSize={boardSize} backToHome={backToHome}/> 
